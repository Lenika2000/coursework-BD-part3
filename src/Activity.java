...
//функция, которая проверит, что допустимое время начала не больше допустимого времени конца
    ...
    public static void createActivities() throws IOException {
        ...
        for (int i = 0; i < 150 ; i++) {
            nFile.write(String.format( "INSERT INTO \"активность\" (\"допустимое_время_начала\"," +
                    ...
                    time[(int) ( Math.random() * time.length)], time[(int) ( Math.random() * time.length)],
